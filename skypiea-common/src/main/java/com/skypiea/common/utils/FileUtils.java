 ...
 * 作者: huangwenjian
 * 描述:
 * 创建时间: 2017-03-21 18:57
 */

import com.skypiea.common.cons.MemoryConstants;
...
public class FileUtils {
    ...
    public static boolean rename(File file, String newName) {
        ...
        // 新的文件名为空返回false
        if (TextUtils.isSpace(newName)) return false;
        // 如果文件名没有改变返回true
    ...
    public static String getFileMD5ToString(String filePath) {
        File file = TextUtils.isSpace(filePath) ? null : new File(filePath);
