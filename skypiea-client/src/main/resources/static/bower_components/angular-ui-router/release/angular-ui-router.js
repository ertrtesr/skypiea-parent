...
function $UrlMatcherFactory() {
   ...
   *        runtime starts.  The com.skypiea.system.model.result of this function is merged into the existing `definition`.
  ...
  this.Param = function Param(id, type, config, location) {
     ...
     * default value, which may be the com.skypiea.system.model.result of an injectable function.
     */
...
function $StateProvider(   $urlRouterProvider,   $urlMatcherFactory) {
   ...
   *   var com.skypiea.system.model.result = {},
   *       views = parent(state);
   *
   *   angular.forEach(views, function (config, name) {
   *     var autoName = (state.name + '.' + name).replace('.', '/');
   *     config.templateUrl = config.templateUrl || '/partials/' + autoName + '.html';
   *     com.skypiea.system.model.result[name] = config;
   *   });
   *   return com.skypiea.system.model.result;
   * });
   *
   ...
   *     it is injected and return value it treated as dependency. If com.skypiea.system.model.result is a promise, it is
...
angular.module('ui.router.state')
  ...
  .run(['$injector', function ($injector) {
    // Allow tests (stateSpec.js) to turn this off by defining this com.skypiea.system.model.constant
